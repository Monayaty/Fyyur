...
1- open git bash in the project folder or cd the project folder.
2- command lines: creating our virtual environment to add packages in it
virtualenv env
3-  source env/scripts/activate
4-  pip install -r requirements.txt
5-  pip install postgres
pip install SQLAlchemy
6- pip install Flask-Migrate
7- npm init -y
8- npm install bootstrap@3
...
## Features
(CRUD) Create , Read , Update , Delete from Shows , Artists and Venues.



## Other sources
1- https://github.com/zalando/connexion/issues/395
2- https://www.codementor.io/@chirilovadrian360/flask-cheat-sheet-and-free-samples-1d7n5uvxx7
3- https://github.com/lucrae/flask-cheat-sheet
4- https://www.michaelcho.me/article/many-to-many-relationships-in-sqlalchemy-models-flask
5- https://wtforms.readthedocs.io/en/2.3.x/fields/
6- https://stackoverflow.com/questions/44926465/upload-image-in-flask